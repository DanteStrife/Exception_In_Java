...
public class Seminar_3_4 {
    public static void main(String[] args) {
        String[][] array = {{"-1", "5", "0", "4"},
                            {"1", "34", "0", "2"},
                            {"27", "13", "63", "2"},
                            {"27", "13", "63", "2"}};
...
class MyArrayDataException extends NumberFormatException {
    public MyArrayDataException(int i, int j) {
        super("Невозможно преобразовать элемент в числовой формат, находяшийся на позиции -> (" + i + ", " + j + ")");
    }

    public MyArrayDataException() {
        super("Невозможно преобразовать элемент в числовой формат");
    }
}
